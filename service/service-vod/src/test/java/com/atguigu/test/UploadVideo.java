...
public class UploadVideo {
    //账号AK信息（必选）
    private static final String accessKeyId = "LTAI4G2U75AJFL4aeSAvSRwb";
    //账号AK信息（必选）
    private static final String accessKeySecret = "MkzIawfHi9SWjhykgXclydvJmMlddS";
    ...
    public static void main(String[] args) {
        ...
        //文件名必须包含扩展名
        String fileName = "D:\\BaiduNetdiskDownload\\谷粒学院\\6 - What If I Want to Move Faster.mp4";
        //本地文件上传
